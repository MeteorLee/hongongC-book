...
- [03 변수와 데이터 입력](#03-변수와-데이터-입력)
  - [03-1 변수](#03-1-변수)
    ...
    - [💻 코드 및 예제](#-코드-및-예제-2)
      - [여러가지 자료형](#여러가지-자료형)
      - [unsigned 잘못 사용한 경우](#unsigned-잘못-사용한-경우)
      - [유효 숫자](#유효-숫자)
      - [문자열](#문자열)
    - [🎯 배운 점 \& 인사이트](#-배운-점--인사이트-1)
      - [C언어에서 int와 long이 같은 이유](#c언어에서-int와-long이-같은-이유)
      - [java는 왜 같을까?](#java는-왜-같을까)
      - [C언어는 플랫폼 종속적](#c언어는-플랫폼-종속적)
  - [03-2 데이터 입력](#03-2-데이터-입력)
    - [📌 핵심 개념](#-핵심-개념-5)
    - [💻 코드 및 예제](#-코드-및-예제-3)
      - [연속 입력](#연속-입력)
      - [문자와 문자열 입력](#문자와-문자열-입력)
  - [리뷰](#리뷰-2)
      - [**플랫폼 종속적 vs 독립적**](#플랫폼-종속적-vs-독립적)
- [04 연산자](#04-연산자)
...
- 연속 입력은 `Space Bar`, `Tab`, `Enter`로 구분한다
