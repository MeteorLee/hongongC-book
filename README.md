...
따라서 컴파일 과정을 통해 `10`과 `20` 정수의 데이터로 `+` 연산자는 명령어로 변환하는 과정(컴파일)이 필요하다
...
위의 내용대로 컴퓨터는 실수를 근사치로 저장하기에 실수 끼리의 연산 과정에서 문제가 발생한다.

- 0.1 + 0.2 = 0.3?

```
0.1 = 0.0001100110011001100110011001100110011001100110011...
0.2 = 0.001100110011001100110011001100110011001100110011... 
0.1 + 0.2 = 0.0100110011001100110011... = 0.30000000000000004
```

컴퓨터 내부에서 비트끼리 연산이 일어날 경우 문제가 발생한다.  
